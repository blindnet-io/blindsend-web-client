...
const view = (): Html<any> => _ => {
  ...
  addEventListener('resize', () => {
    if (innerWidth > 991) {
      document.querySelector('.main-navigation__icon')?.classList.remove('open')
      document.querySelector('body')?.classList.remove('hidden')
      document.querySelector('.site-header__inner')?.classList.remove('active')
      document.querySelector('.secondary-menu__header')?.classList.remove('active')
    }
  })
