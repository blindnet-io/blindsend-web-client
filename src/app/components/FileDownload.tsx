    ...
    case 'Hidden':
      return (
        <div className="main-download__files" key={id}>
          <svg style={{ filter: 'blur(4px)' }} className="main-download__files-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <span style={{ filter: 'blur(4px)' }} className="main-download__file-name">Hidden file {id}</span>
          <span style={{ filter: 'blur(4px)' }} className="main-download__file-disabled">
    ...
    case 'Visible':
      return (
        <div className="main-download__files" key={id}>
          ...
          {state.downloading
            ?
            <span className="main-download__file" style={{ cursor: 'default' }}>
              <span style={{ cursor: 'default' }}><span id={`progress-${id}`}>0</span> %</span>
            </span>
            :
